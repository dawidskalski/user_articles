...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i4.ArticlesRemoteRetrofitdDataSource>(
        () => _i4.ArticlesRemoteRetrofitdDataSource(gh<_i3.Dio>()));
    gh.factory<_i5.ArticlesRepository>(() => _i5.ArticlesRepository(
        remoteDataSource: gh<_i4.ArticlesRemoteRetrofitdDataSource>()));
